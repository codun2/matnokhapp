...
data class SubDto(val id: Int, val status: String, val plan_name: String?, val plan_name_en: String? = null, val plan_type: String?, val price: Double = 0.0, val starts_at: String?, val ends_at: String?, val days_left: Int?)
...
data class SectionDto(val id: Int, val name: String, val icon: String?, val products_count: Int = 0, val name_en: String? = null)
...
data class SectionBody(val name: String, val icon: String?, val name_en: String? = null)
...
data class PAddon(val name: String, val price: Double, val name_en: String? = null)
data class ProductDto(val id: Int, val name: String, val description: String?, val section_id: Int?, val section: String?, val price: Double, val price_before: Double = 0.0, val discount: Int = 0, val status: String, val images: List<String> = emptyList(), val addons: List<PAddon> = emptyList(), val stock: List<PStock> = emptyList(), val name_en: String? = null, val description_en: String? = null, val section_en: String? = null)
data class ProductsResp(val branches: List<BranchMini>, val products: List<ProductDto>)
data class ProductBody(val name: String, val description: String?, val store_section_id: Int?, val price: Double, val price_before: Double?, val status: String, val images: List<String>, val addons: List<PAddon>, val stock: Map<String, Int>, val name_en: String? = null, val description_en: String? = null)
